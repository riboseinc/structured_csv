...
RSpec.describe StructuredCsv::Csv2Yaml do
    ...
    context 'given value " 005 ; 006 ; true ; false ;true;false"' do
      ...
      [
        ...
        },
        {
          ...
          expected:       %w[005 006 true false true false]
        },
        {
          type_in_string: "array{string}",
          expected:       %w[005 006 true false true false]
  ...
  describe ".parse_metadata" do
    ...
    [
      ...
      {
        value:    [%w[test a b], %w[test c d]],
        expected: { "test" => "c" }
      },
      {
        value:    [%w[test 1 boolean], %w[test c d]],
        expected: { "test" => "c" }
      },
      {
  ...
  describe ".convert" do
    ...
    context "when given directory has csv files" do
      ...
      it "does not throw error" do
        expect { command.call(csv_file) }.not_to raise_error RuntimeError
      end
